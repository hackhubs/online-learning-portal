...
from courses.views import HomeView,AboutView,ContactView,CourseListView, CourseDetailView,LessonDetailView, SearchView,create_class,create_subjects,create_lesson
...
urlpatterns = [
    ...
    path('create/subjects',create_subjects,name='create_subjects'),
